...
![image](../assets/img/pdf-reader-image.jpeg)
...
En este caso está vacío. Si hubieran serían así:
...
En la carpeta de react se debe crear el archivo con el que se va a trabajar, en este caso : `PdfReader.tsx`, luego crear su carpeta de componentes y empezar a desarrollar
